                ...
                <div key={index} style={{ border: '1px solid #e5e7eb', borderRadius: '16px', padding: '24px', backgroundColor: 'white', display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ display: 'flex', gap: '12px', marginTop: 'auto' }}>
                    <button 
                      ...
                      style={{ flex: 1, backgroundColor: '#2563eb', color: 'white', padding: '12px', borderRadius: '8px', fontWeight: 'bold', border: 'none', cursor: 'pointer', transition: 'background-color 0.2s' }}
