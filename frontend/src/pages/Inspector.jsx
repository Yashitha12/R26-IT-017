...
export const Inspector = () => {
  const { activeVerifiedDid, showToast } = useApp();
  ...
  return (
    <section className="portal-pane active" style={{ maxWidth: '1280px', margin: '0 auto', padding: '24px 20px' }}>
      <div className="welfare-header-card" style={{ background: '#ffffff', borderRadius: '16px', padding: '32px', border: '1px solid #e2e8f0', marginBottom: '24px' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#e0f2fe', color: '#0369a1', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: 700, marginBottom: '12px' }}>
          <i className="fa-solid fa-chart-network"></i>
          SmartGrama Cryptographic Explorer
        </div>
        <h1 style={{ fontSize: '1.8rem', fontWeight: 800, color: '#0f172a', margin: '0 0 8px' }}>Decentralized Identity &amp; Audit Inspector</h1>
      ...
      >
        <input
          ...
          style={{ flex: 1, minWidth: '280px', padding: '12px', borderRadius: '8px', border: '1px solid #cbd5e1', fontSize: '14px' }}
        />
        <button
          type="button"
          style={{ padding: '12px 24px', background: '#0d9488', color: '#fff', border: 'none', borderRadius: '8px', fontWeight: 700, cursor: 'pointer' }}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '20px' }}>
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <span style={{ background: '#0284c7', color: '#fff', padding: '2px 8px', borderRadius: '6px', fontSize: '11px', fontWeight: 700 }}>
              RESOLVED
            </span>
          </div>
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <span style={{ background: '#10b981', color: '#fff', padding: '2px 8px', borderRadius: '6px', fontSize: '11px', fontWeight: 700 }}>
              ✓ FINALIZED
            </span>
          </div>
